	...
	<div class="row">
		<div class="col-lg-9">
				<?php
					...
					{
						$sql = "SELECT * FROM post WHERE type = 'article' ORDER BY id DESC LIMIT $news_per_page OFFSET $skipped_news";
